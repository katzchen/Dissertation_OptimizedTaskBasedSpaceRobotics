function AllVariables = LoadAllVariables_SRMS_simple()
...
AllVariables.Task.task_start=[4.3508    2.4570    7.4396];% [ 8.1975    7.6881    8.3128]; %of the main payload relative to global;
AllVariables.Task.task_end= [7 0 2];%[4.7558    1.9424    0.9391];
%theta is about [z Y X] 
AllVariables.Task.theta_task_start=[20 135 20]*pi/180;%[2.0989 3.2847 1.715]; %of the main payload relative to global;
AllVariables.Task.theta_task_end=[0 0 0];%[4.5137 4.8884 0.5093];
AllVariables.Task.npoints=10; %HALF the number of points used in trajecotries
...
AllVariables.Arm(1).xyz_base =  [0 -2 0]; %base of arm 1
...
AllVariables.Arm(1).PayloadGrip=[-AllVariables.Task.Lpayload(1)/2 -AllVariables.Task.Lpayload(1)/2 0*AllVariables.Task.Lpayload(3)];%[-AllVariables.Task.Lpayload(1)/4  -0*AllVariables.Task.Lpayload(2)/2 -AllVariables.Task.Lpayload(3)/2];
AllVariables.Arm(1).theta_grasp_start=[-0*pi/2 0 0];%[-0*pi/180 0*pi/180 0*pi/180]; %relative to the payload
...
AllVariables.Arm(1).MaxDeflectionPerLength = 1/200;
...
AllVariables.Arm(2).xyz_base =  [0 2 0];%[3.5 0 0]; %base of arm 2
AllVariables.Arm(2).ArmLength= AllVariables.Arm(1).ArmLength;
AllVariables.Arm(2).Armoffset= AllVariables.Arm(1).Armoffset;% .1 .6 .4];
AllVariables.Arm(2).PayloadGrip=[-AllVariables.Task.Lpayload(1)/2  AllVariables.Task.Lpayload(2)/2 0*AllVariables.Task.Lpayload(3)/2];%[AllVariables.Task.Lpayload(1)/4  -0*AllVariables.Task.Lpayload(2)/2 AllVariables.Task.Lpayload(3)/2];
AllVariables.Arm(2).theta_grasp_start=[-0*90 0 0]*pi/180;%[-((2)*10)*pi/180 -0*pi/180 0*pi/180];
