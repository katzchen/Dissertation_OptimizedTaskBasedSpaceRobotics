function [x,fval,populationsize] = GA_RunDualArmConstraintwithOutput_3links(allowsinglearmanswers,armnumber,mainiteration)
close all, clc
%%
...
if allowsinglearmanswers> 0
    ...
    NumberofVariables = 6;    
    InitialPopulzationMatrix = [.25 .25 .25 .25 .25; 35 35 35 35 35];
    populationsize = 200
else
    'only 1 arm'
    NumberofVariables = 3;    
    InitialPopulzationMatrix = [.25 .25 .25; 35 35 35];
    populationsize = 100;
end
...
if allowsinglearmanswers==1
    char2 = '\GA_superExample_3links_DualArm';
else
