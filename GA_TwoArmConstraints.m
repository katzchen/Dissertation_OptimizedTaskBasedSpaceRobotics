...
ga_mincon =@(x)MultiGA_pose_mass(x,AllVariables);
optionsga = optimoptions(@gamultiobj,'MaxGenerations',100,'Display','diagnose','FunctionTolerance',10,...
    'MaxStallGenerations',50,'PlotFcn',{@gaplotpareto,@gaplotscorediversity},'UseParallel', true, 'UseVectorized', false);
...
[x,fval,exitflag,output]  = gamultiobj(ga_mincon,length(x0),A,b,Aeq,beq,lb,ub,[],optionsga)
